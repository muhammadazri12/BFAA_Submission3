...
import com.muhammadazri.githubuserfinalproject.ui.activity.MainActivity
...
class Reminder: BroadcastReceiver() {
    ...
    fun setRepeatingReminder(context: Context?){
        ...
        FancyToast.makeText(context, context.getString(R.string.reminder_enabled), FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, false).show()
    }
    ...
    fun cancelAlarm(context: Context?){
        ...
        FancyToast.makeText(context, context.getString(R.string.reminder_disabled), FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show()
    }
}